...
# Fixed typo in endpoint URL: changed "/qr-coes/" to "/qr-codes/"
@router.post("/qr-codes/", response_model=QRCodeResponse, status_code=status.HTTP_201_CREATED, tags=["QR Codes"])  # CORRECTED TYPO
...
# Fixed parameter name typo: changed "qr_fileame" to "qr_filename"
@router.delete("/qr-codes/{qr_filename}", status_code=status.HTTP_200_OK, tags=["QR Codes"])  # CORRECTED TYPO
